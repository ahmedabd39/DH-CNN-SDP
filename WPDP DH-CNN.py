...
df = pd.read_csv("ant-1.5_with_cfgnodsafterover.csv")
df1 = pd.read_csv("ant-1.5_with_cfgnodsafterover.csv")
...
glove_file = open('xerces-1.2_node2vec_embeddings.txt', encoding="utf8")
...
glove_file2 = open('xerces-1.2_word2vec_embedding.txt', encoding="utf8")
...
output = Dense(2, activation='softmax')(concat_layer)
